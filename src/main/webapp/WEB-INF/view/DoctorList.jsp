			...
			<section>
				...
				<div style="padding-left: 85%;">
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target="#exampleModal">Add Doctor</button>
				</div>
				<!-- Modal -->
						...
						<div class="modal-content">
							...
							<div class="modal-body">
									...
									<div class="form-group">
										<label for="inputAddress">Specification</label> <form:input
											class="form-control" path="specification" placeholder="Specification" />
									</div>
					...
					<tbody>
						...
						<c:forEach var="doctorlist" items="${doctorlist}">
							<tr>
								...
								<td>${doctorlist.specification}</td>
							</tr>
						</c:forEach>
