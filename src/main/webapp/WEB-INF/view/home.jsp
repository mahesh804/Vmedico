	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			Role(s): <security:authentication property="principal.authorities" />
				...
				<div class="col-7">
				<security:authorize access="hasRole('ROLE_ADMIN')">
				<img src="https://i.dlpng.com/static/png/6385741_preview.png" alt="Admin" height=350 width=500>
				</security:authorize>
				<security:authorize access="hasRole('ROLE_DOCTOR')">
				<img src="https://images-na.ssl-images-amazon.com/images/I/61JFIYaJKVL._AC_SL1252_.jpg" alt="Admin" height=350 width=500>
				</security:authorize>
				<security:authorize access="hasRole('ROLE_PATIENT')">
				<img src="https://image.freepik.com/free-vector/man-profile-cartoon_18591-58482.jpg" alt="Admin" height=350 width=500>
				</security:authorize>
				</div>
			</div>
